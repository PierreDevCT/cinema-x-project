...
import DatosProximos from "../componentes/datos/DatosProximos";


const DetalleProximos = () => {

  const {proxId} = useParams();

  const pelicula = DatosProximos.find(peli => peli.id === parseInt(proxId));
...
export default DetalleProximos;